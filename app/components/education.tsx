...
export const Education = () => (
  <section className="space-y-8 py-16">
    ...
    <Card className="group relative overflow-hidden border-zinc-800 bg-linear-to-br from-zinc-900 to-zinc-950 p-8">
      ...
      <div className="relative space-y-6">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-zinc-800">
          <GraduationCap className="h-8 w-8 text-zinc-100" />
        </div>
        <div>
          <h3 className="mb-1 font-bold text-2xl">{EDUCATION.degree}</h3>
          <p className="font-medium text-zinc-300">{EDUCATION.school}</p>
        </div>
        <div className="flex items-center justify-between border-zinc-800 border-t pt-4">
          ...
          <span className="font-mono text-sm text-zinc-500">{EDUCATION.period}</span>
        </div>
      </div>
    </Card>
  </section>
